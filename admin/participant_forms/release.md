...
I represent and warrant that I am **18 years of age or older**. I understand that CAN.dy participation is limited to adults and that I am entering into this Agreement voluntarily and on my own behalf.

### 2. Description and Nature of Activities
I understand that this is a **participatory event** in which I will actively dance, and that CAN.dy showcases **sensual movement, including heels dance and chair dance**, through rehearsals, live performances, and video productions. The Activities may involve strenuous physical exertion, dancing in heeled footwear, floor and chair work, lifts or supported movement, and **consent-based partnering and physical contact** choreography.

### 3. Assumption of Risk
I acknowledge and understand that the Activities involve inherent and other risks, which may include but are not limited to:
- Slips, trips, falls, and collisions;
- Sprains, strains, muscle or ligament injuries, fractures, and other musculoskeletal injuries;
- Injuries related to dancing in heels, chair work, or floor work;
- Injuries arising from physical contact or partnering with other participants;
- Aggravation of pre-existing conditions;
- Injuries caused by the condition of studio or venue premises, equipment, or the acts or omissions of other participants; and
- Risks of illness, including communicable disease, associated with close-contact activity.

I understand that these risks **cannot be eliminated** regardless of the care taken to avoid injury. I voluntarily and knowingly **assume all such risks**, both known and unknown, and accept full responsibility for any resulting injury, illness, disability, death, or property loss.
